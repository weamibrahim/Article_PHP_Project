...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-image: url(../../assets/dist/img/peakpx\ \(17\).jpg); background-repeat: no-repeat; height: 100%; background-size: cover">
  ...
  <a href="../../../../Article_PHP_Project/Demo/views/home/index.php" class="brand-link" style="text-decoration: none;">
    <img src="../../assets/dist/img/article.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8; margin-top: 3px; width: 50px; height:50px">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item" id="article">
          <?php
          $role = $_SESSION['auth_user']['user_role'];
          if ($role == "admin" || $role == "editor") 
          echo'<a href="../../../../Article_PHP_Project/Demo/views/groups/show.php" class="nav-link">
            <img src="../../assets/dist/img/people (2).png" class="nav-icon" style="width: 30px; margin-bottom: 10px">
        ...
        <li class="nav-item" id="article">
          ...
          $role = $_SESSION['auth_user']['user_role'];
          if ($role == "admin" || $role == "editor") 
          echo'<a href="../../../../Article_PHP_Project/Demo/views/users/user_show.php" class="nav-link">
        ...
        <li class="nav-item" id="article">
          ...
          $role = $_SESSION['auth_user']['user_role'];
          if ($role == "admin" || $role == "editor") 
          echo'<a href="../../../../Article_PHP_Project/Demo/views/articles/show.php" class="nav-link">
        ...
        <li class="nav-item" id="article">
          ...
          $role = $_SESSION['auth_user']['user_role'];
          if ($role == "admin" || $role == "editor") 
          echo'<a href="../../../../Article_PHP_Project/Demo/views/charts/chart.php" class="nav-link">
